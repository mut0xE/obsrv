...
mod tests {
    ...
    const TRANSFER_BASE64: &str = "AQABAwAAAAAAAAAGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAcAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQICAAEMAgAAAEBCDwAAAAAA";
    const TRANSFER_BASE: &str = "";
    ...
    fn test_inspect_payload() {
        let result = decode_payload(TRANSFER_BASE);
        assert!(result.is_ok());
